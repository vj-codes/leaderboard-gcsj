...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          <div className="logo mob:border-b mob:border-b-gray-200 flex justify-center items-center">
            <div className="img w-16 h-1w-16 rounded-full ">
              <Image src="/assets/gdsc-mescoe.png" alt="me" width="64" height="64" />
            </div>
            <div className="text flex flex-col justify-start items-start">
              <p className="text-base">Google Devloper Student Club</p>
              <p className="text-xs"> Modern Education Society's COllege of Engineering</p>
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://www.linkedin.com/company/gdscmescoe"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://www.instagram.com/gdsc_mescoe/"><div className="cursor-pointer insta">
            ...
            <Link href="https://twitter.com/gdscmescoe"><div className="cursor-pointer twitter">
            ...
            <Link href="https://medium.com/@dscmescoe"><div className="cursor-pointer medium">
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Devloped By <a href="" className="text-orange-400">GDSC MESCOE</a> </div>
    </>
  )
}
